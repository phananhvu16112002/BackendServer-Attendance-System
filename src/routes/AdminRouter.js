...
AdminRouter.get("/teachers", VerifyAccessToken, Authorization('admin'), AdminController.getStudents);
AdminRouter.get("/students", VerifyAccessToken, Authorization('admin'), AdminController.getTeachers);
